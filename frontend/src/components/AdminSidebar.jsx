...
export default function AdminSidebar() {
    ...
    return (
        <aside className="bg-stone-900 dark:bg-[#131313] h-screen w-64 fixed left-0 top-0 flex flex-col h-full py-6 px-4 shadow-[20px_0_40px_rgba(0,0,0,0.5)] z-50">
            ...
            <div className="mt-auto pt-6 border-t border-stone-800/50 flex items-center gap-3 px-2">
                ...
                <div>
                    ...
                    <p className="text-[10px] text-stone-500 uppercase tracking-wider">Quản Trị Viên Cao Cấp</p>
                </div>
            </div>
        </aside>
    )
